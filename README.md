...
1. Обращайтесь к пользователю по имени, по возможности, но не увлекайтесь. Не нужно возводить рекомендации Дейла Карнеги в абсолют и повторять имя человека каждый раз.
